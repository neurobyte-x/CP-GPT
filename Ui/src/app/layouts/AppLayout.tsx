...
const navItems = [
  ...
  { to: "/app/problem/1", label: "Problem Explorer", icon: Code2 },
  ...
  const SidebarContent = () => (
    <>
        ...
        {navItems.map((item) => (
          ...
          >
            ...
            {item.highlight && !collapsed && (
              <span className="ml-auto px-1.5 py-0.5 text-[10px] bg-primary/20 text-primary rounded" style={{ fontWeight: 600 }}>
                AI
              </span>
            )}
          </NavLink>
      ...
      <div className="px-3 py-4 border-t border-border/50 space-y-1">
        <button className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-all w-full">
        ...
        <header className="h-14 border-b border-border/50 flex items-center justify-between px-4 lg:px-6 bg-background/80 backdrop-blur-sm shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="relative hidden sm:block">
              ...
              />
              <kbd className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground bg-accent px-1.5 py-0.5 rounded border border-border/50" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                ⌘K
              </kbd>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-neon-orange/10 border border-neon-orange/20">
              ...
              <span className="text-sm text-neon-orange" style={{ fontWeight: 600 }}>7 day streak</span>
            </div>
            ...
            >
              ...
              <span style={{ fontWeight: 500 }}>Ask Coach</span>
            </button>
            <button className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-neon-purple flex items-center justify-center">
